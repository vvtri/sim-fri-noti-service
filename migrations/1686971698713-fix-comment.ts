...
export class FixComment1686971698713 implements MigrationInterface {
    name = 'FixComment1686971698713'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "noti" ADD "resource_id" integer NOT NULL`);
        await queryRunner.query(`ALTER TYPE "public"."noti_template_type_enum" RENAME TO "noti_template_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."noti_template_type_enum" AS ENUM('COMMENT', 'MENTION', 'LIKE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."noti_type_enum" AS ENUM('COMMENT', 'LIKE')`);
        ...
        await queryRunner.query(`ALTER TABLE "noti" DROP COLUMN "sender_type"`);
        await queryRunner.query(`CREATE TYPE "public"."noti_sender_type_enum" AS ENUM('USER')`);
        await queryRunner.query(`ALTER TABLE "noti" ADD "sender_type" "public"."noti_sender_type_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."noti_template_type_enum_old" cascade`);
        await queryRunner.query(`DROP TYPE "public"."noti_type_enum_old" cascade`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."noti_template_type_enum_old" AS ENUM('COMMENT', 'MENTION')`);
        ...
        await queryRunner.query(`ALTER TABLE "noti" DROP COLUMN "sender_type"`);
        await queryRunner.query(`DROP TYPE "public"."noti_sender_type_enum"`);
        await queryRunner.query(`ALTER TABLE "noti" ADD "sender_type" character varying`);
        await queryRunner.query(`CREATE TYPE "public"."noti_type_enum_old" AS ENUM('COMMENT', 'MENTION')`);
        ...
        await queryRunner.query(`DROP TYPE "public"."noti_template_type_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."noti_template_type_enum_old" RENAME TO "noti_template_type_enum"`);
        await queryRunner.query(`ALTER TABLE "noti" DROP COLUMN "resource_id"`);
    }
